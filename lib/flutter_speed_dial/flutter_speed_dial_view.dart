...
class FlutterSpeedDialView extends StatefulWidget {
  final ValueNotifier<ThemeMode> theme;

  const FlutterSpeedDialView({super.key, required this.theme});
  @override
  _FlutterSpeedDialViewState createState() => _FlutterSpeedDialViewState();
}

class _FlutterSpeedDialViewState extends State<FlutterSpeedDialView>
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: const Text("flutter_speed_dial"),
          centerTitle: true,
        ),
                          ...
                          ElevatedButton(
                              onPressed: () {
                                Navigator.of(context).push(
                                  MaterialPageRoute(
                                    builder: (_) => FlutterSpeedDialView(
                                        theme: widget.theme),
                                  ),
                                );
                              },
